...
const ICONS = {
  ...
  'Fumigation': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="1.5" y="10" width="4" height="4" rx="1" fill="currentColor" stroke="none"/><path d="M6.5 10.8c1.8 0 1.8 1.7 3.6 1.7s1.8-1.7 3.6-1.7s1.8 1.7 3.6 1.7c1.3 0 1.8-.7 2.3-1.4" stroke-width="1.5"/><path d="M6.5 13.2c1.8 0 1.8-1.7 3.6-1.7s1.8 1.7 3.6 1.7s1.8-1.7 3.6-1.7c1.3 0 1.9.8 2.3 1.5" stroke-width="1.1" opacity=".5"/></svg>',
